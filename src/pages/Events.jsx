...
const Events = () => {
    ...
    return (
        <>
            <SEOHead
                title={searchTerm ? `Search: ${searchTerm} - Events` : selectedCategory !== 'All' ? `${selectedCategory} Events` : 'Explore All Events'}
                description={`Discover ${selectedCategory !== 'All' ? selectedCategory.toLowerCase() : 'amazing'} events ${locationFilter !== 'All' ? 'in ' + locationFilter : 'near you'}. Browse ${filteredEvents.length}+ live events, concerts, workshops, and conferences. Book tickets instantly with Tickify.`}
                keywords={[
                    'events near me',
                    'upcoming events',
