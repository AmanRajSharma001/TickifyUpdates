    ...
    return (
        <>
            <SEOHead
                ...
                description="Have questions about Tickify? Contact our support team for help with event bookings, payments, refunds, or partnerships. We respond within 24-48 hours. Email: Contacttickify@gmail.com"
                keywords={[
                    'contact tickify',
                    'tickify support',
                    'event booking help',
                    'tickify customer service',
                    'tickify phone number',
                    'tickify email',
